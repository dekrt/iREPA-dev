OUTPUT_DIR="/lpai/output/models/iREPA/eval/JiT_fft_freq-asym-mse"
CKPT_DIR="/lpai/models/repa/jit-dinov3-vit-b16-repa-vanilla-nce/jit-dinov3-vit-b16-repa-vanilla_nce/checkpoint-100.pth"
